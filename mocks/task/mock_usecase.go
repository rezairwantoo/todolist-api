...
func (m *MockTaskUsecase) DeleteTask(ctx context.Context, req model.DeleteTaskRequest) (model.DeleteResponse, error) {
	m.ctrl.T.Helper()
...
func (mr *MockTaskUsecaseMockRecorder) DeleteTask(ctx, req interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteTask", reflect.TypeOf((*MockTaskUsecase)(nil).DeleteTask), ctx, req)
}
...
func (m *MockTaskUsecase) UpdateTask(ctx context.Context, req model.UpdateTaskRequest) (model.UpdateResponse, error) {
	m.ctrl.T.Helper()
...
func (mr *MockTaskUsecaseMockRecorder) UpdateTask(ctx, req interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateTask", reflect.TypeOf((*MockTaskUsecase)(nil).UpdateTask), ctx, req)
}
